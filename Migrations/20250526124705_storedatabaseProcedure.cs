...
{
    /// <inheritdoc />
    public partial class storedatabaseProcedure : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            string createProcedureSql = @"ALTER PROCEDURE [dbo].[PRC_GET_STORE_DATA] (  
                @PCODE      VARCHAR(2)  OUT,  
                ...
                ST.[StoreName],
                ST.StoreType,
                ST.WarehouseManagerId AS WarehouseManagerID,
                ST.WarehouseStatus,
